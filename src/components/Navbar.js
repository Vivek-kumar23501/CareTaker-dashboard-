...
import MessReduction  from './MessReduction';
    ...
    <>
      ...
      {isMobile && (
        <div className="mobile-topbar d-flex justify-content-between align-items-center px-3 py-2 bg-light">
          <Link to="/" className="navbar-brand text-primary fs-5 m-0">Care Taker's Dashboard</Link>
          <FaBars
            size={24}
      ...
      >
        <Nav vertical className="p-3" style={{
width: '250px',
        }}>
          <Link to="/" className="navbar-brand text-primary fs-5 m-0"><h6> <b>Care Taker's Dashboard </b></h6></Link>
          <br />
          <NavItem>
            <Link
              to="/"
